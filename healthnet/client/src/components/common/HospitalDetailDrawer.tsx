...
export const HospitalDetailDrawer: React.FC<HospitalDetailDrawerProps> = ({
  ...
  return (
    <div className="fixed inset-y-0 right-0 z-50 w-full sm:w-[480px] bg-slate-900/95 border-l border-slate-800 shadow-2xl backdrop-blur-xl flex flex-col justify-between overflow-hidden animate-in slide-in-from-right duration-300">
      {/* Header */}
      <div>
        <div className="flex items-start justify-between p-6 border-b border-slate-800 bg-slate-950/60">
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400 font-medium">{hospital.branch_name}</p>
        ...
        <div className="p-6 space-y-6 max-h-[calc(100vh-14rem)] overflow-y-auto custom-scrollbar">
          ...
          <div className="rounded-xl border border-slate-800 bg-slate-950/50 p-4 space-y-3">
            <div className="flex items-center justify-between">
              <span className="text-xs font-semibold uppercase tracking-wider text-slate-400">Emergency Routing Status</span>
          ...
          <div className="space-y-4">
            <h4 className="text-xs font-bold uppercase tracking-wider text-slate-400">Resource Occupancy</h4>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="rounded-xl border border-slate-800 bg-slate-950/40 p-3.5 space-y-1">
              ...
              <div className="text-xl font-bold text-white">
                {hospital.ventilators_available} <span className="text-xs text-slate-500 font-normal">/ {hospital.ventilators_total} free</span>
              </div>
            ...
            <div className="rounded-xl border border-slate-800 bg-slate-950/40 p-3.5 space-y-1">
              ...
              <div className="text-xl font-bold text-white">
                {hospital.doctors_on_duty} <span className="text-xs text-slate-500 font-normal">Docs</span> &bull; {hospital.nurses_on_duty} <span className="text-xs text-slate-500 font-normal">Nurses</span>
              </div>
          ...
          {/* Contact Details */}
          <div className="rounded-xl border border-slate-800 bg-slate-950/30 p-3.5 flex items-center justify-between text-xs">
