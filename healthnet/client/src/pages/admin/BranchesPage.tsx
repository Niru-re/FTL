      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 border-b border-slate-800 pb-5">
        <div>
          <div className="flex items-center gap-3">
            <h1 className="text-xl sm:text-2xl font-bold text-white tracking-tight">Hospital Branch Network</h1>
          ...
          >
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-2 gap-2 bg-slate-950/40 p-3 rounded-xl text-xs">
                ...
                <div>
                  <span className="text-[10px] text-slate-400 block">ICU Capacity</span>
            ...
            <div className="border-t border-slate-800/80 pt-3 flex items-center gap-2">
              <button
                ...
                className="flex-1 rounded-xl bg-slate-800 hover:bg-slate-700 py-2 text-xs font-bold text-teal-400 transition flex items-center justify-center gap-1.5"
              >
              ...
              <button
                ...
                className="flex-1 rounded-xl border border-slate-700 hover:bg-slate-800 py-2 text-xs font-bold text-slate-300 transition flex items-center justify-center gap-1.5"
              >
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-sm">
          <div className="w-full max-w-lg rounded-2xl border border-slate-800 bg-slate-900 p-6 space-y-4 shadow-2xl">
            ...
            <form onSubmit={handleCreateBranch} className="space-y-3">
              <div>
                <label className="text-xs font-semibold text-slate-400">Parent Hospital</label>
                <select
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-sm">
          <div className="w-full max-w-md rounded-2xl border border-slate-800 bg-slate-900 p-6 space-y-4 shadow-2xl">
            <div className="flex items-center justify-between border-b border-slate-800 pb-3">
              ...
              <button onClick={() => setSelectedBranch(null)} className="text-slate-400 hover:text-white">
                <X className="h-4 w-4" />
              </button>
            </div>
