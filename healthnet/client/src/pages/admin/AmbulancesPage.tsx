          ...
          <div className="flex rounded-xl border border-gray-200 bg-gray-100 p-1">
            <button
              ...
              className={`px-3 py-1 text-xs font-bold rounded-lg transition ${
                viewMode === 'CARDS' ? 'bg-sky-600 text-white shadow' : 'text-gray-500 hover:text-white'
              }`}
            >
              Fleet Grid
            </button>
            <button
              ...
              className={`px-3 py-1 text-xs font-bold rounded-lg transition ${
                viewMode === 'MAP' ? 'bg-sky-600 text-white shadow' : 'text-gray-500 hover:text-white'
              }`}
            >
              Map View
            </button>
              ...
              >
                ...
                {(amb.status === 'ARRIVED' || amb.status === 'TRANSPORTING') && (
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-1.5 rounded-lg bg-gray-200 hover:bg-gray-300 py-1.5 text-[11px] font-bold text-gray-600 transition border border-gray-300"
                  >
