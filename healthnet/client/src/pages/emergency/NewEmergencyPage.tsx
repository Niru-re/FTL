          ...
          <div className="rounded-2xl border border-rose-500/30 bg-rose-950/20 p-5 space-y-3 shadow-xl backdrop-blur-sm">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5">
              <button
                ...
                className="flex flex-col items-start p-3 rounded-xl bg-gray-100/90 border border-gray-200 hover:border-rose-500/60 transition group text-left"
              >
                <span className="text-xs font-bold text-gray-800 group-hover:text-rose-300">1. Critical Cardiac</span>
              ...
              <button
                ...
                className="flex flex-col items-start p-3 rounded-xl bg-gray-100/90 border border-gray-200 hover:border-rose-500/60 transition group text-left"
              >
                <span className="text-xs font-bold text-gray-800 group-hover:text-rose-300">2. Severe Respiratory</span>
              ...
              <button
                ...
                className="flex flex-col items-start p-3 rounded-xl bg-gray-100/90 border border-gray-200 hover:border-rose-500/60 transition group text-left"
              >
                <span className="text-xs font-bold text-gray-800 group-hover:text-rose-300">3. Multi-Trauma</span>
              ...
              <button
                ...
                className="flex flex-col items-start p-3 rounded-xl bg-gray-100/90 border border-gray-200 hover:border-rose-500/60 transition group text-left"
              >
                <span className="text-xs font-bold text-gray-800 group-hover:text-rose-300">4. Acute Stroke</span>
          ...
          <form onSubmit={handleFindBestHospital} className="space-y-6">
            <div className="rounded-2xl border border-gray-200 bg-gray-100/70 p-6 space-y-6 shadow-xl backdrop-blur-sm">
              <div className="flex items-center gap-2 border-b border-gray-200 pb-4">
                ...
                <div>
                  <h2 className="text-base font-black text-gray-900">Emergency Patient Intake & Triage</h2>
              ...
              <div>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-3">
                  ...
                  <div className="p-3 rounded-xl bg-gray-50 border border-gray-200">
                    ...
                    <div className="flex items-center gap-1 font-mono text-sm font-bold text-gray-800 mt-1">
                      <input
                        type="number"
                      ...
                      <button
                        ...
                        className={`flex items-center gap-2 p-3 rounded-xl border text-xs font-bold transition text-left ${
                          isChecked
                            ...
                            : 'bg-gray-50/60 border-gray-200 text-gray-500 hover:text-gray-700'
                        }`}
                      >
      ...
      {step === 2 && (
        <div className="space-y-6">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-gray-200 pb-4">
            ...
            <button
              onClick={() => setStep(1)}
              className="flex items-center gap-1.5 rounded-xl bg-gray-200 hover:bg-gray-300 px-3.5 py-2 text-xs font-bold text-gray-600"
            >
                    ...
                    <div className="flex items-center justify-between lg:justify-end gap-4 pt-3 lg:pt-0 border-t lg:border-t-0 border-gray-200">
                      ...
                      <div className="flex items-center gap-2">
                        <button
                          ...
                          className="rounded-xl bg-gray-200 hover:bg-gray-300 px-3.5 py-2 text-xs font-bold text-sky-300 transition border border-gray-300"
                        >
                          Why This Hospital?
                        </button>
        ...
        <div className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="p-4 rounded-xl bg-gray-100 border border-gray-200 space-y-1">
              ...
              <div className="font-bold text-gray-800">{selectedHospital.hospital_name}</div>
            ...
            <div className="p-4 rounded-xl bg-gray-100 border border-teal-500/30 space-y-1">
              ...
              <div className="font-mono font-bold text-gray-800">{selectedBed.code} ({selectedBed.unit_name})</div>
          ...
          <div className="w-full max-w-lg rounded-2xl border border-gray-200 bg-gray-100 p-6 space-y-5 shadow-2xl">
            <div className="flex items-center justify-between border-b border-gray-200 pb-3">
              <div>
                ...
                <h3 className="text-base font-black text-gray-900">Why {showExplanationModal.hospital_name}?</h3>
              </div>
              <button onClick={() => setShowExplanationModal(null)} className="text-gray-500 hover:text-white">
                <X className="h-5 w-5" />
              </button>
            </div>
            ...
            <button
              ...
              className="w-full py-2.5 rounded-xl bg-gray-200 hover:bg-gray-300 text-xs font-bold text-white transition"
            >
              Close Breakdown
            </button>
          </div>
