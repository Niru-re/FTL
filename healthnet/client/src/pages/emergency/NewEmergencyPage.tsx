    ...
    <div className="space-y-6 max-w-6xl mx-auto pb-16">
        ...
        <div className="space-y-6">
          ...
          <div className="rounded-2xl border border-rose-500/30 bg-rose-950/20 p-5 space-y-3 shadow-xl backdrop-blur-sm">
            <div className="flex items-center justify-between">
              ...
              <span className="text-[10px] font-mono text-slate-400">1-Click Auto-Fill</span>
            </div>
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5">
              <button
                type="button"
                onClick={() => loadScenario('CARDIAC')}
                className="flex flex-col items-start p-3 rounded-xl bg-slate-900/90 border border-slate-800 hover:border-rose-500/60 transition group text-left"
              >
                <span className="text-xs font-bold text-white group-hover:text-rose-300">1. Critical Cardiac</span>
                <span className="text-[10px] text-slate-400">STEMI, ICU, Cardiologist</span>
              </button>
              <button
                type="button"
                ...
                className="flex flex-col items-start p-3 rounded-xl bg-slate-900/90 border border-slate-800 hover:border-rose-500/60 transition group text-left"
              >
                <span className="text-xs font-bold text-white group-hover:text-rose-300">2. Severe Respiratory</span>
                <span className="text-[10px] text-slate-400">Hypoxemic, Ventilator</span>
              </button>
              <button
                type="button"
                ...
                className="flex flex-col items-start p-3 rounded-xl bg-slate-900/90 border border-slate-800 hover:border-rose-500/60 transition group text-left"
              >
                <span className="text-xs font-bold text-white group-hover:text-rose-300">3. Multi-Trauma</span>
                <span className="text-[10px] text-slate-400">MVC, Trauma Surgeon</span>
              </button>
              <button
                type="button"
                ...
                className="flex flex-col items-start p-3 rounded-xl bg-slate-900/90 border border-slate-800 hover:border-rose-500/60 transition group text-left"
              >
                <span className="text-xs font-bold text-white group-hover:text-rose-300">4. Acute Stroke</span>
                <span className="text-[10px] text-slate-400">tPA Window, Neurologist</span>
              </button>
            </div>
          </div>
          ...
          <form onSubmit={handleFindBestHospital} className="space-y-6">
            <div className="rounded-2xl border border-slate-800 bg-slate-900/70 p-6 space-y-6 shadow-xl backdrop-blur-sm">
              <div className="flex items-center gap-2 border-b border-slate-800 pb-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-400">Enter patient vitals and required clinical resources</p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                  <label className="text-[11px] font-bold text-slate-400 uppercase">Patient Name</label>
                  <input
                    type="text"
                    required
                ...
                <div className="grid grid-cols-2 gap-2">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full mt-1 rounded-xl bg-slate-950 border border-slate-800 p-2.5 text-xs font-bold text-rose-400"
                    >
              ...
              {/* Condition Summary */}
              <div>
                <label className="text-[11px] font-bold text-slate-400 uppercase">Clinical Condition Description</label>
                <textarea
                  rows={2}
                  required
                  value={formData.condition_summary}
                  onChange={(e) => setFormData({ ...formData, condition_summary: e.target.value })}
                  className="w-full mt-1 rounded-xl bg-slate-950 border border-slate-800 p-2.5 text-xs text-white leading-relaxed"
                />
              </div>

              {/* Live Vitals Grid */}
              <div>
                <label className="text-[11px] font-bold text-slate-400 uppercase block mb-2">Emergency Baseline Vitals</label>
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-3">
                  ...
                  <div className="p-3 rounded-xl bg-slate-950 border border-slate-800">
                    <span className="text-[10px] text-slate-500 uppercase font-bold block">Respiration (/min)</span>
                    <input
                      type="number"
                  ...
                  <div className="p-3 rounded-xl bg-slate-950 border border-slate-800">
                    <span className="text-[10px] text-slate-500 uppercase font-bold block">Temp (&deg;C)</span>
                    <input
                      type="number"
                      step="0.1"
                  ...
                  <div className="p-3 rounded-xl bg-slate-950 border border-slate-800">
                    <span className="text-[10px] text-slate-500 uppercase font-bold block">Dept</span>
                    <select
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5">
                  {[
                    ...
                    return (
                      ...
                      >
                        <div className={`p-1 rounded-lg ${isChecked ? 'bg-sky-500 text-slate-950' : 'bg-slate-800 text-slate-400'}`}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                <div className="md:col-span-2">
                  <label className="text-[11px] font-bold text-slate-400 uppercase">Incident Address</label>
                  <input
                    type="text"
                    required
                ...
                <div className="grid grid-cols-2 gap-2">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full mt-1 rounded-xl bg-slate-950 border border-slate-800 p-2.5 text-xs text-white font-mono"
                    />
                  </div>
                  <div>
              ...
              <div className="pt-4 border-t border-slate-800 flex justify-end">
                <button
                  type="submit"
                  disabled={isLoading}
                  className="flex items-center gap-2 rounded-2xl bg-gradient-to-r from-rose-600 to-rose-500 hover:from-rose-500 hover:to-rose-400 px-8 py-3.5 text-sm font-black text-white shadow-xl shadow-rose-600/30 transition"
                >
      ...
      {step === 2 && (
        <div className="space-y-6">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-slate-800 pb-4">
            ...
            <button
              onClick={() => setStep(1)}
              className="flex items-center gap-1.5 rounded-xl bg-slate-800 hover:bg-slate-700 px-3.5 py-2 text-xs font-bold text-slate-300"
            >
                  ...
                  <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
                    ...
                    <div className="space-y-2 flex-1">
                      <div className="flex flex-wrap items-center gap-2">
                        ...
                        <span className="text-xs text-slate-400">({m.branch_name})</span>
                        {!m.is_eligible && (
                    ...
                    <div className="flex items-center justify-between lg:justify-end gap-4 pt-3 lg:pt-0 border-t lg:border-t-0 border-slate-800">
                      <div className="text-right">
                        <span className="text-[10px] font-bold text-slate-400 uppercase block">Prototype Suitability</span>
                        <div className="text-3xl font-black text-white font-mono">
                          {m.suitability_score} <small className="text-xs text-slate-400">/ 100</small>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center gap-2">
                        <button
                          ...
                          className="rounded-xl bg-slate-800 hover:bg-slate-700 px-3.5 py-2 text-xs font-bold text-sky-300 transition border border-slate-700"
                        >
                          Why This Hospital?
                        </button>
                        ...
                        {m.is_eligible ? (
                          <button
                            ...
                            className="flex items-center gap-1.5 rounded-xl bg-emerald-600 hover:bg-emerald-500 px-4 py-2 text-xs font-bold text-white transition shadow-md shadow-emerald-600/20"
                          >
                          ...
                          <button
                            disabled
                            className="rounded-xl bg-slate-800/40 px-3.5 py-2 text-xs font-bold text-slate-500 cursor-not-allowed"
                          >
                            Ineligible
                          </button>
                        )}
      ...
      {step === 3 && selectedHospital && (
        <div className="space-y-6">
          <div className="rounded-2xl border border-emerald-500/30 bg-emerald-950/20 p-5 flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <span className="text-xs text-slate-400">{selectedHospital.branch_name} &bull; Suitability {selectedHospital.suitability_score}% &bull; ETA {selectedHospital.eta_minutes} mins</span>
              </div>
            </div>
          ...
          {/* Beds Grid */}
          <div className="rounded-2xl border border-slate-800 bg-slate-900/70 p-6 space-y-4 shadow-xl backdrop-blur-sm">
            <div className="flex items-center justify-between border-b border-slate-800 pb-3">
              <div>
                ...
                <p className="text-xs text-slate-400">Choose from immediately available ICU / Critical Care beds</p>
              </div>
                    ...
                    >
                      <div className="flex items-start justify-between">
                        <div>
                          ...
                          <span className="text-[10px] text-slate-400">{bed.department_name} ({bed.unit_name})</span>
                        </div>
                      ...
                      <div className="flex items-center gap-2 text-[10px] text-slate-400 pt-1 border-t border-slate-800/80">
                        <span>Vent: <strong className={bed.has_ventilator ? 'text-emerald-400' : 'text-slate-500'}>{bed.has_ventilator ? 'Ready' : 'N/A'}</strong></span>
                        <span>&bull;</span>
                        <span>Monitor: <strong className={bed.has_monitor ? 'text-emerald-400' : 'text-slate-500'}>{bed.has_monitor ? 'Active' : 'N/A'}</strong></span>
                      </div>
                    </div>
                  );
                })}
            ...
            <div className="pt-4 border-t border-slate-800 flex justify-end gap-3">
              ...
              <button
                ...
                className="flex items-center gap-2 rounded-xl bg-teal-600 hover:bg-teal-500 px-6 py-2.5 text-xs font-bold text-white transition shadow-md"
              >
        ...
        <div className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="p-4 rounded-xl bg-slate-900 border border-slate-800 space-y-1">
              <span className="text-[10px] font-bold text-slate-400 uppercase">Receiving Facility</span>
          ...
          <div className="rounded-2xl border border-slate-800 bg-slate-900/70 p-6 space-y-4 shadow-xl backdrop-blur-sm">
            <div className="flex items-center justify-between border-b border-slate-800 pb-3">
              <div>
                ...
                <p className="text-xs text-slate-400">Assign nearby emergency vehicle with telemetry integration</p>
              </div>
              <span className="text-xs font-mono text-slate-300">{availableAmbulances.length} Units Online</span>
            </div>
                  ...
                  >
                    <div className="space-y-1">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-[10px] text-slate-400">({amb.vehicle_number})</span>
                        <span className="text-[9px] font-bold px-1.5 py-0.2 rounded bg-slate-800 text-slate-300 uppercase">
                          {amb.status}
                        </span>
                      </div>
                      <div className="text-xs text-slate-400">
                        Crew: <strong className="text-slate-200">{amb.paramedic_name}</strong> &bull; Driver: {amb.driver_name}
                      </div>
                      <div className="text-[11px] text-slate-500 font-mono">Contact: {amb.phone}</div>
                    </div>
                    ...
                    <div className="text-right">
                      ...
                      <span className="text-[10px] text-slate-400">{amb.distance_km} km away</span>
                    </div>
                  </div>
                );
              })}
            ...
            <div className="pt-4 border-t border-slate-800 flex justify-end gap-3">
              ...
              <button
                ...
                className="flex items-center gap-2 rounded-2xl bg-rose-600 hover:bg-rose-500 px-8 py-3 text-xs font-black text-white transition shadow-xl shadow-rose-600/30"
              >
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/85 backdrop-blur-sm">
          <div className="w-full max-w-lg rounded-2xl border border-slate-800 bg-slate-900 p-6 space-y-5 shadow-2xl">
            <div className="flex items-center justify-between border-b border-slate-800 pb-3">
              ...
              <button onClick={() => setShowExplanationModal(null)} className="text-slate-400 hover:text-white">
                <X className="h-5 w-5" />
              </button>
            </div>
            ...
            <div className="flex items-center justify-between p-4 rounded-xl bg-slate-950 border border-slate-800">
              <div>
                <span className="text-xs font-bold text-slate-400">Total Prototype Suitability Score</span>
                <p className="text-[11px] text-slate-500">Normalized weighted multi-criteria index</p>
              </div>
            ...
            <div className="space-y-2.5">
              <span className="text-xs font-bold text-slate-300 uppercase tracking-wider block">5-Pillar Score Breakdown</span>
              <div className="space-y-2">
                <div className="flex justify-between text-xs p-2 rounded-lg bg-slate-950 border border-slate-800">
                  <span className="text-slate-300">1. Resource Availability (30% weight)</span>
                  <strong className="font-mono text-sky-300">{showExplanationModal.resource_score} / 30 pts</strong>
                </div>
                <div className="flex justify-between text-xs p-2 rounded-lg bg-slate-950 border border-slate-800">
                  <span className="text-slate-300">2. Clinical Capability & Specialists (25% weight)</span>
                  <strong className="font-mono text-sky-300">{showExplanationModal.clinical_score} / 25 pts</strong>
                </div>
                <div className="flex justify-between text-xs p-2 rounded-lg bg-slate-950 border border-slate-800">
                  <span className="text-slate-300">3. Travel Time & Simulated ETA (20% weight)</span>
                  <strong className="font-mono text-sky-300">{showExplanationModal.eta_score} / 20 pts</strong>
                </div>
                <div className="flex justify-between text-xs p-2 rounded-lg bg-slate-950 border border-slate-800">
                  <span className="text-slate-300">4. Hospital Capacity & ICU Load (15% weight)</span>
                  <strong className="font-mono text-sky-300">{showExplanationModal.capacity_score} / 15 pts</strong>
                </div>
                <div className="flex justify-between text-xs p-2 rounded-lg bg-slate-950 border border-slate-800">
                  <span className="text-slate-300">5. Emergency Department Readiness (10% weight)</span>
            ...
            <div className="space-y-2 pt-2 border-t border-slate-800">
              <span className="text-xs font-bold text-slate-300 uppercase tracking-wider block">Clinical Checklist Rationale</span>
