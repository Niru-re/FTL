  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="bg-white p-5 rounded-3xl border border-slate-200 shadow-xs flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        <div>
          <span className="text-[11px] font-bold uppercase tracking-wider text-slate-400">Medical Records</span>
      ...
      {isLoading ? (
        ...
        <div className="bg-white rounded-3xl border border-slate-200 p-10 text-center text-slate-500">
          ...
          <p className="text-xs text-slate-400 mt-1">Authorized medical summaries will appear here once finalized by your physician.</p>
        </div>
      ) : (
          ...
          {documents.map((doc) => (
            ...
            >
              ...
              <div className="pt-3 border-t border-slate-100 flex items-center justify-between">
                <span className="text-[10px] text-slate-400">PDF • Verified Record</span>
