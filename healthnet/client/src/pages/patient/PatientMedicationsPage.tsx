  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="bg-white p-5 rounded-3xl border border-slate-200 shadow-xs flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        <div>
          <span className="text-[11px] font-bold uppercase tracking-wider text-gray-500">Prescription Schedule</span>
      ...
      {isLoading ? (
        ...
        <div className="bg-white rounded-3xl border border-slate-200 p-10 text-center text-gray-400">
          <Pill className="w-8 h-8 text-gray-500 mx-auto mb-2" />
                ...
                <div className="flex items-start justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-400 mt-0.5">{med.schedule}</p>
                    </div>
                  </div>
                  <span
