  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="bg-white p-5 rounded-3xl border border-slate-200 shadow-xs">
        <span className="text-[11px] font-bold uppercase tracking-wider text-slate-400">Demographics</span>
        ...
        <div className="bg-white rounded-3xl border border-slate-200 p-6 shadow-xs space-y-4">
          <div className="flex items-center gap-3.5 pb-4 border-b border-slate-100">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500">MRN: {profile.mrn}</p>
            </div>
          </div>
        ...
        <div className="bg-white rounded-3xl border border-slate-200 p-6 shadow-xs space-y-4">
          <div className="flex items-center gap-3 pb-4 border-b border-slate-100">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500">Designated Caregiver</p>
            </div>
          </div>
