  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-5 gap-3.5">
        <div className="bg-gray-100/60 p-3.5 rounded-2xl border border-gray-200/80">
          <p className="text-[10px] uppercase font-bold text-gray-400">Total Ward Beds</p>
        ...
        <div className="bg-gray-100/60 p-3.5 rounded-2xl border border-gray-200/80 col-span-2 sm:col-span-1">
      ...
      <div className="rounded-2xl border border-gray-200/80 bg-gray-100/60 p-4 backdrop-blur-md shadow-xl flex flex-col md:flex-row items-center justify-between gap-4">
        <div className="relative w-full md:w-80">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 bg-gray-50/70 border border-gray-200 rounded-xl text-xs text-gray-900 placeholder-slate-500 focus:outline-none focus:border-teal-500"
          />
        </div>
            ...
            >
              <div>
                ...
                <div className="space-y-1 text-xs">
                  <p className="text-gray-500 text-[11px]">{bed.department_name}</p>
                  {bed.patient_name ? (
                    <div className="pt-1">
                      ...
                      {bed.patient_mrn && (
                        <p className="text-[10px] font-mono text-gray-500">{bed.patient_mrn}</p>
                      )}
                      {bed.doctor_name && (
                    ...
                    <p className="text-gray-400 italic pt-1">No patient currently assigned</p>
                  )}
                </div>
              </div>
              ...
              <div className="pt-2 border-t border-gray-200/60">
                {allowedTransitions.length > 0 ? (
                  ...
                  <p className="text-[10px] text-center text-gray-400 font-mono">Administrative Managed</p>
                )}
              </div>
            </div>
          );
            ...
            <form onSubmit={handleStatusSubmit} className="space-y-4">
              <div>
                ...
                <select
                  ...
                  className="w-full bg-gray-50 border border-gray-200 text-xs font-bold text-gray-900 rounded-xl p-3 focus:outline-none focus:border-teal-500"
                >
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-gray-50 border border-gray-200 text-xs text-gray-900 rounded-xl p-2.5 focus:outline-none focus:border-teal-500"
                />
              </div>
