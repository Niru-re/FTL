  ...
  if (!patient) {
    return (
      <div className="rounded-2xl border border-slate-800 bg-slate-900/60 p-8 text-center space-y-4">
        <p className="text-sm text-slate-400">Patient not found or unauthorized access.</p>
        <Link
          to="/nurse/patients"
  ...
  return (
    <div className="space-y-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs text-slate-400">{patient.department_name}</span>
            </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        {/* Profile Card */}
        <div className="md:col-span-3 rounded-2xl border border-slate-800/80 bg-slate-900/60 p-5 backdrop-blur-md shadow-xl space-y-4">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 text-xs">
            <div>
              <p className="text-slate-500 font-medium">Age / Gender</p>
            ...
            <div>
              <p className="text-slate-500 font-medium">Assigned Bed</p>
          ...
          <div className="pt-2 border-t border-slate-800/80 grid grid-cols-1 sm:grid-cols-3 gap-4 text-xs">
            <div className="sm:col-span-1">
              <p className="text-slate-500 font-medium">Primary Clinical Diagnosis</p>
              <p className="font-semibold text-rose-300 mt-0.5">{patient.diagnosis}</p>
            </div>
            <div>
              <p className="text-slate-500 font-medium">Attending Physician</p>
            ...
            <div>
              <p className="text-slate-500 font-medium">Charge Nurse</p>
              <p className="font-semibold text-slate-200 mt-0.5 flex items-center gap-1.5">
        ...
        {/* Status Callout */}
        <div className="rounded-2xl border border-slate-800/80 bg-slate-900/60 p-5 backdrop-blur-md shadow-xl flex flex-col justify-between">
          <div>
        ...
        {latestV ? (
          <div className="grid grid-cols-2 sm:grid-cols-6 gap-3">
            <div className="bg-slate-950/60 p-3 rounded-xl border border-slate-800 text-center">
              <p className="text-[10px] uppercase font-bold text-slate-500">SpO2</p>
            ...
            <div className="bg-slate-950/60 p-3 rounded-xl border border-slate-800 text-center">
              <p className="text-[10px] uppercase font-bold text-slate-500">Blood Pressure</p>
            ...
            <div className="bg-slate-950/60 p-3 rounded-xl border border-slate-800 text-center">
              <p className="text-[10px] uppercase font-bold text-slate-500">Consciousness</p>
              <p className="text-base font-black font-mono text-teal-300 mt-1">
                {latestV.consciousness || 'ALERT'}
              </p>
              <span className="text-[9px] font-bold text-slate-400">AVPU Score</span>
            </div>
          </div>
        ) : (
          <p className="text-xs text-slate-400">No vitals logged yet for this patient.</p>
        )}
      </div>
        ...
        <div className="rounded-2xl border border-slate-800/80 bg-slate-900/60 p-5 backdrop-blur-md shadow-xl space-y-4">
          <div className="flex items-center justify-between border-b border-slate-800 pb-3">
            <div>
              ...
              <p className="text-[11px] text-slate-400">Ward observations and nursing documentation</p>
            </div>
            <button
          ...
          <div className="space-y-3 max-h-80 overflow-y-auto pr-1">
            {patient.nursing_notes.length === 0 ? (
              <p className="text-xs text-slate-400 text-center py-6">No nursing notes logged yet.</p>
            ) : (
        ...
        <div className="rounded-2xl border border-slate-800/80 bg-slate-900/60 p-5 backdrop-blur-md shadow-xl space-y-4">
          <div className="flex items-center justify-between border-b border-slate-800 pb-3">
            <div>
              ...
              <p className="text-[11px] text-slate-400">Active doses & administration verification</p>
            </div>
            <Link
          ...
          <div className="space-y-2.5 max-h-80 overflow-y-auto pr-1">
            {patient.medications.length === 0 ? (
              <p className="text-xs text-slate-400 text-center py-6">No active medications scheduled.</p>
            ) : (
                ...
                >
                  <div className="space-y-0.5 text-xs">
                    ...
                    <p className="text-slate-400 text-[11px]">
                      Dose: <span className="text-slate-200">{med.dosage}</span> • Route: <span className="font-mono text-teal-300">{med.route}</span> • Freq: {med.frequency}
                    </p>
            ...
            <form onSubmit={handleRequestDoctor} className="space-y-4">
              <div>
                ...
                <select
                  ...
                  className="w-full bg-slate-950 border border-slate-800 text-xs text-white rounded-xl p-2.5 focus:outline-none focus:border-sky-500"
                >
